...
<div class="container-fluid">
    ...
    <div class="row">
        <div class="col-lg">
            ...
            <a href="" class="btn btn-info mb-3" data-toggle="modal" data-target="#exampleModal">Add New Submenu</a>
                ...
                <tbody>
                    ...
                    foreach ($subMenu as $sm) : ?>
                        <tr>
                            ...
                            <td><?= $sm['is_active'] ?></td>
                            <td>
                                <a href="<?= base_url('menu/editsub/' . $sm['id']) ?>" class="badge badge-info">Edit</a>
        ...
        <div class="modal-content">
            ...
            <form action="<?= base_url('menu/submenu/'); ?>" method="post">
                ...
                <div class="modal-footer">
                    ...
                    <button type="submit" class="btn btn-info">Add Submenu</button>
                </div>
            </form>
        </div>
    </div>
